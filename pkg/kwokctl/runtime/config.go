...
type Runtime interface {
	...
	// StartComponents start cluster component(s)
	StartComponents(ctx context.Context, name ...string) error

	// StopComponents stop cluster component(s)
	StopComponents(ctx context.Context, name ...string) error
